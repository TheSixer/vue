...
//  获取活动详情
export const activityDetailApi = data => Util.http.get('/activity/detail?activityId=' + data.activityId, {})
//  参与活动
...
//  获取免费票、礼物、礼包
export const getMyPoll = data => Util.http.get('/activity_member/poll', {})
//  投免费票
...
//  赠礼支付页面-
export const payGift = data => Util.http.get('/poll/gift_pay?giftId=' + data.giftId, {})
//  礼物-余额支付-
...
//  获取用户信息
export const getUserInfo = data => Util.http.get('/member/detail', {})
//  我的银行卡
export const getBankCards = data => Util.http.get('/member_bank/list', {})
//  用户-添加银行卡
...
//  用户-余额记录
export const getAccountRecord = data => Util.http.get('/member/balanceRecord', {})
//  用户-积分记录
export const getIntegralRecord = data => Util.http.get('/member/integralRecord', {})
//  用户-提现页面
export const withdraw = data => Util.http.get('/member/withdraw', {})
//  用户-申请提现
export const withdrawApply = data => Util.http.post('/member/withdraw_apply', data, {})
//  我的关注
export const myAttention = data => Util.http.get('/member_attention/list/', {})
//  添加关注
export const addAttention = data => Util.http.post('/member_attention/add', data, {})
//  取消关注
export const cancleAttention = data => Util.http.delete('/member_attention/cancal?memberAttentionId=' + data.memberAttentionId, {})
//  我的收藏
export const myCollect = data => Util.http.get('/member_collect/list/', {})
//  添加收藏
...
//  谁为我投票
export const getMyFans = data => Util.http.get('/poll/my', {})
//  用户关系
